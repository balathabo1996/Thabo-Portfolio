...
export async function POST(request) {
  try {
    ...
    const skills = [
      ...
      { name: 'Windows Administration', category: 'infra', icon: 'fab fa-windows', order: 1 },
      { name: 'Linux Administration', category: 'infra', icon: 'fab fa-linux', order: 2 },
      { name: 'Cloud (GCP, AWS, Azure)', category: 'infra', icon: 'fas fa-cloud', order: 3 },
      { name: 'Active Directory', category: 'infra', icon: 'fas fa-users-cog', order: 4 },
      { name: 'DHCP', category: 'infra', icon: 'fas fa-network-wired', order: 5 },
      { name: 'Printer Management', category: 'infra', icon: 'fas fa-print', order: 6 },
      { name: 'User & Permission Management', category: 'infra', icon: 'fas fa-user-shield', order: 7 },
      { name: 'Backup & Disaster Recovery', category: 'infra', icon: 'fas fa-save', order: 8 },
      { name: 'OS Patching', category: 'infra', icon: 'fas fa-sync', order: 9 },

      // Virtualization & Tools (virt)
      { name: 'Hyper-V', category: 'virt', icon: 'fas fa-microchip', order: 10 },
      { name: 'VMware', category: 'virt', icon: 'fas fa-layer-group', order: 11 },
      { name: 'Citrix', category: 'virt', icon: 'fas fa-desktop', order: 12 },
      { name: 'Git / GitHub', category: 'virt', icon: 'fab fa-github', order: 13 },
      { name: 'JIRA', category: 'virt', icon: 'fab fa-jira', order: 14 },
      { name: 'ServiceNow', category: 'virt', icon: 'fas fa-ticket-alt', order: 15 },
      { name: 'Postman (Automated Testing)', category: 'virt', icon: 'fas fa-vial', order: 16 },
      { name: 'Swagger (OpenAPI 3.1)', category: 'virt', icon: 'fas fa-file-code', order: 17 },
      { name: 'Tableau', category: 'virt', icon: 'fas fa-chart-pie', order: 18 },
      { name: 'Microsoft Report Builder', category: 'virt', icon: 'fas fa-table', order: 19 },
      ...
      { name: 'Bootstrap', category: 'prog', icon: 'fab fa-bootstrap', order: 30 },
      { name: 'XML', category: 'prog', icon: 'fas fa-code', order: 31 },

      // Databases (db)
      { name: 'Microsoft SQL Server', category: 'db', icon: 'fas fa-database', order: 32 },
      { name: 'PostgreSQL', category: 'db', icon: 'fas fa-database', order: 33 },
      ...
      { name: 'System Hardening', category: 'sec', icon: 'fas fa-lock', order: 37 },
      { name: 'Security Protocols', category: 'sec', icon: 'fas fa-shield-alt', order: 38 },
      { name: 'GRC & Risk Awareness', category: 'sec', icon: 'fas fa-exclamation-triangle', order: 39 },
      { name: 'Documentation', category: 'sec', icon: 'fas fa-file-alt', order: 40 },

      // Soft Skills & Leadership (soft)
      { name: 'Communication', category: 'soft', icon: 'fas fa-comments', order: 41 },
      { name: 'Teamwork', category: 'soft', icon: 'fas fa-users', order: 42 },
      { name: 'Adaptability', category: 'soft', icon: 'fas fa-sync-alt', order: 43 },
      { name: 'Problem-Solving', category: 'soft', icon: 'fas fa-lightbulb', order: 44 },
      { name: 'Leadership', category: 'soft', icon: 'fas fa-user-tie', order: 45 },
      { name: 'Time Management', category: 'soft', icon: 'fas fa-clock', order: 46 },
      { name: 'Crisis Management', category: 'soft', icon: 'fas fa-fire-extinguisher', order: 47 }
    ];
