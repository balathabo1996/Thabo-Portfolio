...
export default function AdminDashboard() {
  ...
  const fetchAllData = async (key) => {
    ...
    const fetchItems = [
      { url: `/api/analytics/resume?t=${timestamp}`, setter: (data) => setStats({ resumeDownloads: data.count || 0 }), name: "Stats" },
      { url: `/api/profile?t=${timestamp}`, setter: setProfile, name: "Profile" },
      { url: `/api/projects?t=${timestamp}`, setter: setProjects, name: "Projects" },
      { url: `/api/experience?t=${timestamp}`, setter: setExperience, name: "Experience" },
      ...
      <main className="content-area" style={{ padding: 0 }}>
        <div className="top-bar" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div style={{ width: '4px', height: '24px', background: '#4f46e5', borderRadius: '4px' }}></div>
            <h2 style={{ fontSize: '1.1rem', fontWeight: 800, margin: 0, letterSpacing: '0.025em', color: '#f1f5f9' }}>
              {(() => {
                const names = {
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <a href="/" target="_blank" className="btn btn-gray" style={{ 
              padding: '0.5rem 1rem', 
              fontSize: '0.7rem',
              background: 'rgba(30, 41, 59, 0.5)',
              border: '1px solid rgba(255, 255, 255, 0.05)'
            }}>
              <i className="fas fa-external-link-alt" style={{ marginRight: '0.5rem' }}></i> View Site
            </a>
            <button onClick={handleLogout} className="btn btn-gray" style={{ 
              padding: '0.5rem 1rem', 
              fontSize: '0.7rem', 
              color: '#f87171',
              ...
              <i className="fas fa-power-off" style={{ marginRight: '0.5rem' }}></i> Logout
            </button>
          </div>
        </div>

        <div className="content-container" style={{ padding: '0 2.5rem 2.5rem 2.5rem' }}>
          {activeTab === "overview" && (
            ...
            <div className="card">
              ...
              >
                ...
                <div className="input-wrap">
                  ...
                  <textarea rows="3" {...register("missionDescription")} />
                </div>
                <div className="input-wrap">
