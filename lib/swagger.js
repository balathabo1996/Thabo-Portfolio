...
const swaggerSpec = {
  ...
  paths: {
    ...
    '/api/experience': {
      ...
      patch: {
        operationId: 'bulkUpdateExperience',
        summary: 'Bulk update experiences',
        description: 'Updates multiple experience documents, primarily used for drag-and-drop reordering. Requires array of experience objects with `_id` and updated `order`. Required auth: x-api-key.',
        tags: ['Experience'],
        security: [{ ApiKeyAuth: [] }],
        requestBody: {
          required: true,
          content: { 'application/json': { schema: { type: 'array', items: { type: 'object', properties: { _id: { type: 'string' }, order: { type: 'number' } }, required: ['_id'] } } } }
        },
        responses: {
          200: { description: 'Experiences bulk updated.' },
          401: { description: 'Unauthorized.' }
        }
      }
    },
    '/api/projects': {
      ...
      patch: {
        ...
        description: 'Updates multiple project documents, primarily used for drag-and-drop reordering. Required auth: x-api-key.',
        tags: ['Projects'],
        security: [{ ApiKeyAuth: [] }],
        requestBody: {
          required: true,
        ...
        responses: {
          200: { description: 'Projects bulk updated.' },
          401: { description: 'Unauthorized.' }
        }
      }
    },
    ...
    '/api/skills': {
      ...
      patch: {
        operationId: 'bulkUpdateSkills',
        summary: 'Bulk update skills',
        description: 'Updates multiple skill documents, primarily used for drag-and-drop reordering. Required auth: x-api-key.',
        tags: ['Skills'],
        security: [{ ApiKeyAuth: [] }],
        requestBody: {
          required: true,
        ...
        responses: { 200: { description: 'Skills bulk updated.' }, 401: { description: 'Unauthorized.' } }
      },
    },
