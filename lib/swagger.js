 ...
 *   POST /api/seed         – Reset + Populate database (x-api-key required)
...
const swaggerSpec = {
  ...
  info: {
    ...
    description:
      ...
      'Manages profile data, work/education history, projects, resume PDF delivery, contact form emails, and API documentation.\n\n' +
  ...
  paths: {
        ...
        responses: {
          200: {
            ...
            headers: {
              ...
              'Content-Disposition': { schema: { type: 'string', example: 'inline; filename="resume.pdf"' } },
            },
            content: { 'application/pdf': {} },
          },
          404: { description: 'No resume document found in the database.' },
    ...
    '/api/resume': {
      post: {
        ...
        description: 'Uploads a new resume PDF to MongoDB. Required auth: x-api-key.',
        tags: ['Resume'],
        security: [{ ApiKeyAuth: [] }],
        requestBody: {
          content: {
            'multipart/form-data': {
              schema: {
                type: 'object',
                properties: {
                  file: { type: 'string', format: 'binary', description: 'The PDF file to upload' },
                },
              },
            },
          },
